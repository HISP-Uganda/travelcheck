...
import { Fab, Icon, Footer, FooterTab, Button, Text, Container, Content, List, ListItem, Body, Right } from 'native-base';
                ...
                <List>
                    {
                        Object.keys(data).map(function(key) {
                            ...
                            return <ListItem
                                    ...
                                    onPress={() => navigation.navigate('SecurityDetails',{screen: 'SecurityDetails',params: { details: securityDetails }})}
                                >
                                     <Body>
                                       <Text style={{textTransform: 'uppercase', fontSize: 12, fontWeight: 'bold'}}>{data[key].instance}</Text>
