                ...
                <ListItem
                  ...
                  onPress={() =>
                    navigation.navigate('Details', {
                      screen: 'Details',
                      params: {scan_id: id, details: scanDetails},
                    })
                  }
                  style={{
                    marginLeft: 0,
                    paddingLeft: 0,
                    textColor:
                      data[key].submitted === true ? '#1E8449' : '#5D6D7E',
                  }}>
                  <Body>
                    ...
                    <Text note>
                      {checkscans[key].poe_id + ' - ' + data[key].checkpoint}
                    </Text>
                  </Body>
                  <Right style={{alignItems: 'center'}}>
                    ...
                    <Icon
                      name={
                        data[key].submitted == true ? 'done-all' : 'checkmark'
                      }
                      style={{
                        color:
                          data[key].submitted == true ? '#229954' : '#F39C12',
                        fontSize: 24,
                      }}
                    />
                    ;
