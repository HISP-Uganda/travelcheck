            ...
            <View style={{flex: 1}}>
              <Body>
                <View>
                  ...
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {scan_details.vehicle}
                  </Text>
                  <Text>Phone Number:</Text>
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {scan_details.phone_number}
                  </Text>
                </View>
                <View>
                  ...
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {scan_details.checkpoint}
                  </Text>
                  <Text>Coordinate: </Text>
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {'(' +
                      scan_details.latitude +
                      ',' +
                      scan_details.longitude +
                      ')'}
                  </Text>
                </View>
                <View>
                  ...
                  <Text>Scan Date:</Text>
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {moment(scan_details.scan_date).format('dddd MMM Do YYYY') +
                      ', ' +
                      scan_details.scan_time}
                  </Text>
                </View>
                ...
                <View>
                  ...
                  <Text note numberOfLines={1} style={styles.textDetail}>
                    {scan_details.submitted === true
                      ? 'Submitted'
                      : 'Not Submitted'}
                  </Text>
                  <View>
                    {scan_details.submitted ? (
                      <TouchableOpacity
