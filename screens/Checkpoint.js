...
class CheckpointDetails extends Component {
  ...
  render() {
    const {current, checkpoint_details} = this.state;
      ...
      <View style={styles.scrollViewStyle}>
           <Card style={{height: '100%', backgroundColor: 'yellow', marginTop: 0, marginLeft: 0, marginRight: 0, marginBottom: 0}}>
               <CardItem header bordered style={{backgroundColor: '#ffd700', height: '10%', alignItems: 'center'}}>
                 <Text style={styles.detailedTextTitle}>{checkpoint_details.name}</Text>
               </CardItem>
               <CardItem bordered style={{height: '90%'}} >
                   ...
                   <Body>
                       <View>
                           ...
                           <Text note numberOfLines={1} style={styles.textDetail}>{checkpoint_details.scan_point}</Text>
                           <Text>Status</Text>
                           <Text note numberOfLines={1} style={styles.textDetail}>{(checkpoint_details.current === true)? "Active": "Inactive"}</Text>
                       </View>
                       ...
                       <View>
                           ...
                           <ListItem noindent>
                                 <Body  >
                                   <Text style={{marginLeft: 0}}>{(checkpoint_details.current)? "Deactivate Checkpoint": "Activate Checkpoint"}</Text>
                                 </Body>
                                 <Right>
                                       <Switch
