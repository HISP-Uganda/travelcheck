              ...
              <Body>
                <View>
                  ...
                  <Text
                    note
                    numberOfLines={2}
                    style={styles.securityTextDetail}>
                  ...
                  <Text
                    ...
                    numberOfLines={1}
                    style={styles.securityTextDetail}>
                    {security_details.current === true ? 'Active' : 'Inactive'}
                  </Text>
                </View>
