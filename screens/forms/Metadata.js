...
class Metadata extends Component {
  ...
  processMetadata = async () => {
    ...
    let realm = await Realm.open({
      schema: [SecuritySchema, OrganisationUnitSchema, ProgramSchema],
    });
          ...
          {programs !== false ? (
            <Form>
              ...
              {!isEmpty(orgUnits) ? (
                ...
                <Text>SELECT PROGRAM PROCEED</Text>
              )}
            ...
            <Text>NO RECORDS FOUND. CHECK DHIS2 Settings</Text>
          )}
        </View>
      </Content>
    );
